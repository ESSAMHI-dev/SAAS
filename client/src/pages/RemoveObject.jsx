...
const RemoveObject = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (!object.trim()) return toast.error("Please describe an object.");
    if (object.split(" ").length > 1)
      return toast.error("Please enter just one object name");
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        {!content ? (
          ...
          <img
            src={content}
            alt="processed"
            className="mt-3 w-full h-auto rounded-md border"
          />
        )}
      </div>
    </div>
